...
devices = dict(
    ...
    heater=device('devices.epics.EpicsDigitalMoveable',
                  ...
                  readpv=pvs('RANGE2'),
                  writepv=pvs('RANGE_S2'),
                  lowlevel=True,
                  ),
    T_p=device('devices.epics.EpicsAnalogMoveable',
               description='P-parameter of control loop channel B.',
               readpv=pvs('P2'),
               writepv=pvs('P_S2'),
               lowlevel=True,
               ),
    T_i=device('devices.epics.EpicsAnalogMoveable',
               description='I-parameter of control loop channel B.',
               readpv=pvs('I2'),
               writepv=pvs('I_S2'),
               lowlevel=True,
               ),
    T_d=device('devices.epics.EpicsAnalogMoveable',
